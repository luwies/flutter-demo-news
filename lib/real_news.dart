...
class RealNews extends StatefulWidget {
  @override
...
class _MyAppState extends State<RealNews> with AutomaticKeepAliveClientMixin {
  ...
  Future<void> fetchPost() async {
    ...
    final response = await http
        .get('https://api.xinwen.cn/news/all?size=15${getPubicParams()}');
    isLoading = false;
